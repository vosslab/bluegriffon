...
{"id": "bkgnd_color", "title": "สีพืนหลังเปลียน / ความทึบ"},
{"id": "circle_cx", "title": "Cx วงกลมเปลียนของพิกัด"},
{"id": "circle_cy", "title": "วงกลมเปลียนเป็น cy ประสานงาน"},
{"id": "circle_r", "title": "รัศมีวงกลมเปลียนเป็น"},
{"id": "connector_no_arrow", "textContent": "No arrow"},
{"id": "copyrightLabel", "textContent": "Powered by"},
{"id": "cornerRadiusLabel", "title": "รัศมีเปลียนสีเหลียมผืนผา Corner"},
{"id": "curve_segments", "textContent": "Curve"},
{"id": "ellipse_cx", "title": "เปลียน ellipse ของ cx ประสานงาน"},
{"id": "ellipse_cy", "title": "Ellipse เปลียนของ cy ประสานงาน"},
{"id": "ellipse_rx", "title": "Ellipse เปลียนของรัศมี x"},
{"id": "ellipse_ry", "title": "Ellipse เปลียนของรัศมี y"},
{"id": "fill_color", "title": "เปลียนใสสี"},
{"id": "fitToContent", "textContent": "Fit to Content"},
{"id": "fit_to_all", "textContent": "พอดีกับเนือหาทังหมด"},
{"id": "fit_to_canvas", "textContent": "เหมาะสมในการผาใบ"},
{"id": "fit_to_layer_content", "textContent": "พอดีเนือหาชันที"},
...
{"id": "image_height", "title": "ความสงเปลียนรปภาพ"},
{"id": "image_opt_embed", "textContent": "Embed data (local files)"},
{"id": "image_opt_ref", "textContent": "Use file reference"},
{"id": "image_url", "title": "URL เปลียน"},
{"id": "image_width", "title": "ความกวางเปลียนรปภาพ"},
{"id": "includedImages", "textContent": "Included Images"},
{"id": "largest_object", "textContent": "ทีใหญทีสดในวัตถ"},
{"id": "layer_delete", "title": "Delete Layer"},
{"id": "layer_down", "title": "ยาย Layer ลง"},
{"id": "layer_new", "title": "Layer ใหม"},
{"id": "layer_rename", "title": "Layer เปลียนชือ"},
{"id": "layer_up", "title": "ยาย Layer Up"},
{"id": "layersLabel", "textContent": "ชัน:"},
{"id": "line_x1", "title": "สายเปลียนเป็นเริมตน x พิกัด"},
{"id": "line_x2", "title": "สายเปลียนเป็นสินสด x พิกัด"},
{"id": "line_y1", "title": "สายเปลียนเป็นเริมตน y พิกัด"},
{"id": "line_y2", "title": "สายเปลียนเป็นสินสด y พิกัด"},
...
{"id": "page", "textContent": "หนา"},
{"id": "palette", "title": "คลิกเพือเปลียนใสสีกะคลิกเปลียนสีจังหวะ"},
{"id": "path_node_x", "title": "Change node's x coordinate"},
{"id": "path_node_y", "title": "Change node's y coordinate"},
{"id": "rect_height_tool", "title": "ความสงสีเหลียมผืนผาเปลียน"},
{"id": "rect_width_tool", "title": "ความกวางสีเหลียมผืนผาเปลียน"},
...
{"id": "selectedPredefined", "textContent": "เลือกทีกำหนดไวลวงหนา:"},
{"id": "selected_objects", "textContent": "วัตถเลือกตัง"},
{"id": "selected_x", "title": "Change X coordinate"},
{"id": "selected_y", "title": "Change Y coordinate"},
{"id": "smallest_object", "textContent": "วัตถทีเล็กทีสด"},
{"id": "straight_segments", "textContent": "Straight"},
{"id": "stroke_color", "title": "สีจังหวะเปลียน"},
{"id": "stroke_style", "title": "รีบเปลียนสไตล์จังหวะ"},
{"id": "stroke_width", "title": "ความกวางจังหวะเปลียน"},
...
{"id": "svginfo_height", "textContent": "ความสง:"},
...
{"id": "svginfo_width", "textContent": "ความกวาง:"},
{"id": "text", "title": "เปลียนเนือหาขอความ"},
{"id": "toggle_stroke_tools", "title": "Show/hide more stroke tools"},
{"id": "tool_add_subpath", "title": "Add sub-path"},
{"id": "tool_alignbottom", "title": "ดานลางชิด"},
{"id": "tool_aligncenter", "title": "จัดแนวกึงกลาง"},
{"id": "tool_alignleft", "title": "จัดชิดซาย"},
{"id": "tool_alignmiddle", "title": "กลางชิด"},
{"id": "tool_alignright", "title": "จัดชิดขวา"},
{"id": "tool_aligntop", "title": "ดานบนชิด"},
{"id": "tool_angle", "title": "มมหมนเปลียน"},
{"id": "tool_blur", "title": "Change gaussian blur value"},
{"id": "tool_bold", "title": "ขอความตัวหนา"},
{"id": "tool_circle", "title": "Circle"},
{"id": "tool_clear", "textContent": "รปภาพใหม"},
{"id": "tool_clone", "title": "องค์ประกอบโคลน"},
{"id": "tool_clone_multi", "title": "องค์ประกอบโคลน"},
{"id": "tool_delete", "title": "องค์ประกอบลบ"},
{"id": "tool_delete_multi", "title": "องค์ประกอบทีเลือกลบ"},
{"id": "tool_docprops", "textContent": "คณสมบัติของเอกสาร"},
...
{"id": "tool_fhpath", "title": "เครืองมือดินสอ"},
{"id": "tool_fhrect", "title": "สีเหลียมผืนผา Free-Hand"},
{"id": "tool_font_size", "title": "เปลียนขนาดตัวอักษร"},
{"id": "tool_group", "title": "องค์ประกอบของกลม"},
{"id": "tool_image", "title": "เครืองมือ Image"},
{"id": "tool_import", "textContent": "Import SVG"},
{"id": "tool_italic", "title": "ขอความตัวเอียง"},
{"id": "tool_line", "title": "เครืองมือ Line"},
{"id": "tool_move_bottom", "title": "ยายไปดานลาง"},
{"id": "tool_move_top", "title": "ยายไปดานบน"},
{"id": "tool_node_clone", "title": "Clone Node"},
{"id": "tool_node_delete", "title": "Delete Node"},
{"id": "tool_node_link", "title": "Link Control Points"},
{"id": "tool_opacity", "title": "เปลียนความทึบเลือกรายการ"},
{"id": "tool_open", "textContent": "ภาพเปิด"},
{"id": "tool_path", "title": "Path Tool"},
{"id": "tool_rect", "title": "สีเหลียมผืนผา"},
{"id": "tool_redo", "title": "ทำซำ"},
{"id": "tool_reorient", "title": "Reorient path"},
{"id": "tool_save", "textContent": "บันทึกรปภาพ"},
{"id": "tool_select", "title": "เครืองมือเลือก"},
{"id": "tool_source", "title": "แหลงทีมาแกไข"},
{"id": "tool_source_cancel", "textContent": "ยกเลิก"},
{"id": "tool_source_save", "textContent": "บันทึก"},
{"id": "tool_square", "title": "สีเหลียม"},
{"id": "tool_text", "title": "เครืองมือ Text"},
