...
// rulers-element.js: Custom Element replacement for XBL bindings
// from bindings/rulers.xml (XBL removed in Gecko ESR 140).
//
// Defines three classes forming an inheritance chain:
//   BGRulerBase  - base class (not registered as a custom element)
//   BGHRuler     - horizontal ruler, registered as <bg-hruler>
//   BGVRuler     - vertical ruler, registered as <bg-vruler>

// =============================================================================
// BGRulerBase - base class with shared ruler logic
// =============================================================================
class BGRulerBase extends XULElement {

  constructor() {
    super();
    this.kSVG_NS = "http://www.w3.org/2000/svg";
    this.mRulerSeparatorPosition = null;
  ...
  disconnectedCallback() {
    ...
    NotifierUtils.removeNotifierCallback("resizeEvent",    this.onResizeEvent, this);
    NotifierUtils.removeNotifierCallback("editorScrolled", this.onEditorScrolled, this);
  }

  get mSVGGroup() {
    return this.querySelector('[anonid="SVGGroup"]');
  }
...
// =============================================================================
// BGHRuler - horizontal ruler custom element
// =============================================================================
class BGHRuler extends BGRulerBase {
  ...
  connectedCallback() {
    ...
    // Build SVG anonymous content
    if (!this.querySelector('[anonid="SVGGroup"]')) {
      var svg = document.createElementNS(this.kSVG_NS, "svg");
      svg.setAttribute("style", "width: 100% ! important; height: 16px;");
      svg.setAttribute("height", "16");
      svg.setAttribute("preserveAspectRatio", "xMidYMid meet");

      var g = document.createElementNS(this.kSVG_NS, "g");
      g.setAttribute("anonid", "SVGGroup");
      svg.appendChild(g);

      this.insertBefore(svg, this.firstChild);
    }

    // Event listeners (formerly XBL <handlers>)
  ...
  addObject(aName, aPos, aSize, aSource) {
    if (!aSource)
      return;
    var svgGroup = this.mSVGGroup;
    var g = document.createElementNS(this.kSVG_NS, "g");
  ...
  // --- Mouse event handlers (formerly XBL <handlers>) ---
...
// =============================================================================
// BGVRuler - vertical ruler custom element
// =============================================================================
class BGVRuler extends BGRulerBase {
  ...
  connectedCallback() {
    ...
    if (!this.querySelector('[anonid="SVGGroup"]')) {
      var svg = document.createElementNS(this.kSVG_NS, "svg");
      svg.setAttribute("style", "width: 16px ! important; height: 100% ! important;");
      svg.setAttribute("preserveAspectRatio", "xMidYMid meet");
...
if (!customElements.get("bg-hruler")) {
  customElements.define("bg-hruler", BGHRuler);
}
if (!customElements.get("bg-vruler")) {
  customElements.define("bg-vruler", BGVRuler);
}
