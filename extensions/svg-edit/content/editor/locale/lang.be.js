[
{"id": "align_relative_to", "title": "Выраунаваць па дачыненні да ..."},
...
{"id": "fitToContent", "textContent": "Па памеры утрымання"},
{"id": "fit_to_all", "textContent": "Па памеру усе змесціва"},
{"id": "fit_to_canvas", "textContent": "Памер палатна"},
{"id": "fit_to_layer_content", "textContent": "По размеру слои утрымання"},
{"id": "fit_to_sel", "textContent": "Выбар памеру"},
{"id": "font_family", "title": "Змены Сямеиства шрыфтоу"},
...
{"id": "largest_object", "textContent": "наибуинеишы аб&#39;ект"},
{"id": "layer_delete", "title": "Выдаліць слои"},
{"id": "layer_down", "title": "Перамясціць слои на"},
{"id": "layer_new", "title": "Новы слои"},
{"id": "layer_rename", "title": "Пераименаваць Слои"},
{"id": "layer_up", "title": "Перамяшчэнне слоя да"},
{"id": "layersLabel", "textContent": "Слаі:"},
{"id": "line_x1", "title": "Змены лінія пачынае каардынаты х"},
{"id": "line_x2", "title": "Змяненне за перыяд, скончыуся лінія каардынаты х"},
{"id": "line_y1", "title": "Змены лінія пачынае Y каардынаты"},
{"id": "line_y2", "title": "Змяненне за перыяд, скончыуся лінія Y каардынаты"},
...
{"id": "rect_height_tool", "title": "Змены прастакутнік вышынеи"},
{"id": "rect_width_tool", "title": "Змяненне шырыні прамавугольніка"},
{"id": "relativeToLabel", "textContent": "па параунанні з:"},
...
{"id": "tool_alignmiddle", "title": "Выраунаваць Блізкага"},
...
{"id": "tool_bold", "title": "Тоусты тэкст"},
...
{"id": "tool_fhellipse", "title": "Свабоднаи рукі Эліпс"},
{"id": "tool_fhpath", "title": "Pencil Tool"},
{"id": "tool_fhrect", "title": "Свабоднаи рукі Прастакутнік"},
{"id": "tool_font_size", "title": "Змяніць памер шрыфта"},
{"id": "tool_group", "title": "Група элементау"},
