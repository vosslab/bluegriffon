[
{"id": "align_relative_to", "title": "Aligner par rapport a ..."},
{"id": "bkgnd_color", "title": "Changer la couleur d'arriere-plan / l'opacite"},
...
{"id": "connector_no_arrow", "textContent": "Sans fleches"},
...
{"id": "fit_to_sel", "textContent": "Ajuster a la selection"},
...
{"id": "idLabel", "title": "Identifier l'element"},
{"id": "image_height", "title": "Changer la hauteur de l'image"},
{"id": "image_opt_embed", "textContent": "Incorporer les images en tant que donnees (fichiers locaux)"},
{"id": "image_opt_ref", "textContent": "Utiliser la reference des images "},
{"id": "image_url", "title": "Modifier l'URL"},
{"id": "image_width", "title": "Changer la largeur de l'image"},
{"id": "includedImages", "textContent": "Images incorporees"},
...
{"id": "line_x1", "title": "Changer la position horizontale x de debut de la ligne"},
{"id": "line_x2", "title": "Changer la position horizontale x de fin de la ligne"},
{"id": "line_y1", "title": "Changer la position verticale y de debut de la ligne"},
...
{"id": "linecap_square", "title": "Terminaison : Carree"},
{"id": "linejoin_bevel", "title": "Raccord : Biseaute"},
...
{"id": "relativeToLabel", "textContent": "Relativement a:"},
{"id": "seg_type", "title": "Changer le type du Segment"},
{"id": "selLayerLabel", "textContent": "Deplacer elements vers:"},
{"id": "selLayerNames", "title": "Deplacer les elements selectionnes vers un autre calque"},
{"id": "selectedPredefined", "textContent": "Selectionner predefinis:"},
{"id": "selected_objects", "textContent": "Objets selectionnes"},
...
{"id": "svginfo_bg_note", "textContent": "Note: La toile de fond n'est pas sauvegardee avec l'image."},
{"id": "svginfo_change_background", "textContent": "Toile de fond de l'Editeur"},
{"id": "svginfo_dim", "textContent": "Dimensions du canevas"},
{"id": "svginfo_editor_prefs", "textContent": "Preferences de l'Editeur"},
{"id": "svginfo_height", "textContent": "Hauteur:"},
{"id": "svginfo_icons", "textContent": "Taille des icones"},
{"id": "svginfo_image_props", "textContent": "Proprietes de l'Image"},
...
{"id": "tool_alignleft", "title": "Aligner les cotes gauches"},
{"id": "tool_alignmiddle", "title": "Centrer horizontalement"},
{"id": "tool_alignright", "title": "Aligner les cotes droits"},
...
{"id": "tool_clone", "title": "Cloner l'element"},
{"id": "tool_clone_multi", "title": "Cloner les elements"},
{"id": "tool_delete", "title": "Supprimer l'element"},
{"id": "tool_delete_multi", "title": "Supprimer les elements selectionnes"},
{"id": "tool_docprops", "textContent": "Proprietes du document"},
...
{"id": "tool_fhellipse", "title": "Ellipse main levee"},
{"id": "tool_fhpath", "title": "Crayon a main levee"},
{"id": "tool_fhrect", "title": "Rectangle main levee"},
{"id": "tool_font_size", "title": "Changer la taille de la police"},
{"id": "tool_group", "title": "Grouper les elements"},
...
{"id": "tool_move_bottom", "title": "Deplacer vers le bas"},
{"id": "tool_move_top", "title": "Deplacer vers le haut"},
{"id": "tool_node_clone", "title": "Cloner le nœud"},
{"id": "tool_node_delete", "title": "Supprimer le nœud"},
{"id": "tool_node_link", "title": "Rendre les points de controle solidaires"},
{"id": "tool_opacity", "title": "Changer l'opacite de l'element selectionne"},
...
{"id": "tool_position", "title": "Aligner l'element relativement a la Page"},
{"id": "tool_rect", "title": "Rectangle"},
{"id": "tool_redo", "title": "Refaire l'action"},
{"id": "tool_reorient", "title": "Reorienter le chemin"},
{"id": "tool_save", "textContent": "Envoyer l'image vers BlueGriffon"},
{"id": "tool_select", "title": "Outil de selection"},
...
{"id": "tool_square", "title": "Carre"},
{"id": "tool_text", "title": "Outil Texte"},
{"id": "tool_topath", "title": "Convertir en chemin"},
{"id": "tool_undo", "title": "Annuler l'action"},
{"id": "tool_ungroup", "title": "Degrouper les elements"},
{"id": "tool_wireframe", "title": "Mode Fil de Fer"},
{"id": "tool_zoom", "title": "Zoom"},
{"id": "url_notice", "title": "NOTE: Cette image ne peut etre incorporee en tant que donnees. Le contenu affiche sera celui de l'image situee a cette adresse"},
...
{"id": "sidepanel_handle", "textContent": "C A L Q U E S", "title": "Tirer vers la gauche/droite pour redimensionner le panneau"},
{
 "js_strings": {
  ...
  "QignoreSourceChanges": "Ignorer les modifications faites a la source SVG ?", 
  "QmoveElemsToLayer": "Deplacer les elements selectionnes vers le calque '%s' ?", 
  "QwantToClear": "Voulez-vous effacer le dessin ?\nL'historique de vos actions sera egalement efface !", 
  "cancel": "Annuler", 
  "defsFailOnSave": "NOTE : A cause d'un bug de votre navigateur, cette image peut etre affichee de facon incorrecte (degrades ou elements manquants). Cependant, une fois enregistree, elle sera correcte.", 
  "dupeLayerName": "Il existe deja un calque de ce nom !", 
  ...
  "exportNoBlur": "Les elements ayant du flou gaussien seront affiches sans flou", 
  "exportNoDashArray": "Les contours seront affiches remplis", 
  "exportNoImage": "Les elements Image ne seront pas affiches", 
  "exportNoText": "Le texte peut etre affiche de facon incorrecte", 
  "exportNoforeignObject": "Les elements foreignObject se seront pas affiches", 
  "featNotSupported": "Fonction non supportee", 
  ...
  "key_up": "Haut", 
  "layer": "Calque", 
  "layerHasThatName": "Le calque porte deja ce nom", 
  "loadingImage": "Chargement de l'image, veuillez patienter...", 
  "noContentToFitTo": "Il n'y a pas de contenu auquel ajuster", 
  "noteTheseIssues": "Notez egalement les problemes suivants : ", 
  "ok": "OK", 
  "pathCtrlPtTooltip": "Glisser-deposer le point de controle pour ajuster les proprietes de la courbe", 
  "pathNodeTooltip": "Glisser-deposer le nœud pour le deplacer. Double-cliquer le nœud pour changer de type de segment", 
